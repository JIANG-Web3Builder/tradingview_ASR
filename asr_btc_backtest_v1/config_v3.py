...
FEATURES_BY_VERSION = {
    "v13": StrategyFeatures("v13", "v11_hybrid", 0.5, False, False, True, 136, None, 0.35, True, True, False),
    "v14": StrategyFeatures("v14", "v11_hybrid", 0.5, False, False, True, 136, None, 0.35, True, True, True),
}

VERSION_ORDER = ["v13", "v14"]
