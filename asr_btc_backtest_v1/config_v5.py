...
FEATURES_BY_VERSION = {
    "v14": StrategyFeatures("v14", "v11_hybrid", 0.5, False, False, True, 136, None, 0.35, True, True, True, False),
    "v16": StrategyFeatures("v16", "v11_hybrid", 0.5, False, False, True, 136, None, 0.35, True, True, True, True),
}

VERSION_ORDER = ["v14", "v16"]
