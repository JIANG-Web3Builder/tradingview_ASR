...
class StrategyFeatures:
    ...
    low_progress_l2_half_size: bool
...
FEATURES_BY_VERSION = {
    ...
    "v18": StrategyFeatures("v18", "v11_hybrid", 0.5, False, False, True, 136, None, 0.35, True, True, True, True, True, True),
}

VERSION_ORDER = ["v17", "v18"]
