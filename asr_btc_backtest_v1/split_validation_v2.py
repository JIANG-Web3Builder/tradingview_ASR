...
CANDIDATES = {
    "v17": {
        ...
        "mechanism": "main candidate: no-progress time stop",
    },
    "v18": {
        "equity": Path("output_v7/v18/equity_curve_v7.csv"),
        "trades": Path("output_v7/v18/trades_v7.csv"),
        "mechanism": "defensive: low-progress L2 half-size adds",
    },
    "v19": {
        "equity": Path("output_v8/v19/equity_curve_v8.csv"),
        "trades": Path("output_v8/v19/trades_v8.csv"),
        "mechanism": "defensive: breakout candle confirmation",
    },
}
...
def main() -> None:
    ...
    result.to_csv("split_validation_v2.csv", index=False)
