...
FEATURES_BY_VERSION = {
    "v16": StrategyFeatures("v16", "v11_hybrid", 0.5, False, False, True, 136, None, 0.35, True, True, True, True, False),
    "v17": StrategyFeatures("v17", "v11_hybrid", 0.5, False, False, True, 136, None, 0.35, True, True, True, True, True),
}

VERSION_ORDER = ["v16", "v17"]
